  ...
  <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="{{ asset( '/Carousel.php' ) }}"><img src="{{ asset( 'images/atom-md.png' ) }}"><font size="4">Mumupédia</font></a>
      </div>
      <div class="navbar-collapse collapse">
        <ul class="nav navbar-nav navbar-right">
          <li><a href="{{ asset( '/Carousel.php' ) }}">Home</a></li>          
          <li class="dropdown">
            <a class="dropdown-toggle" data-toggle="dropdown">Articles <span class="badge">{{ News::count() }}</span><span class="caret"></span></a>
            <ul class="dropdown-menu" role="menu">
              <li><a class="btn btn-default" href="{{ asset( '/Articles.php' ) }}">Tous</a></li>
              <li><a href="{{ asset( '/Articles.php#Hydro ' ) }}">L'hydrogéne</a></li>
              <li class="divider"></li>
              <li><a href="{{ asset( '/Articles.php#Prod' ) }}">Production</a></li>
              <li><a href="{{ asset( '/Articles.php#cons' ) }}">Conservation</a></li>
              <li><a href="{{ asset( '/Articles.php#use' ) }}">Utilisation</a></li>
            </ul>
          </li>
